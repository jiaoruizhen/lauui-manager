...
public class Feeder {
	...
	public String toString() {
		return "Feeder [id=" + id + ", version=" + version + ", bluetoothMac=" + bluetoothMac + ", bluetoothUuid="
				+ bluetoothUuid + ", wxBlueId=" + wxBlueId + ", wifiMac=" + wifiMac + ", devUid=" + devUid + ", fwVer="
				+ fwVer + ", password=" + password + ", device=" + device + "]";
	}
